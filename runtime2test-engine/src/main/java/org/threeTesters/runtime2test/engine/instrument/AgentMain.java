...
import org.threeTesters.runtime2test.engine.extract.ClassSerializationType;
import org.threeTesters.runtime2test.engine.instrument.aspects.MutatorCallTraceFactory;
import org.threeTesters.runtime2test.engine.instrument.aspects.SetFieldTraceFactory;
...
import org.threeTesters.runtime2test.construction.util.GlobalSwitches;
        ...
        .transform(
            new ForAdvice()
                ...
                .advice(
                    ...
                    "org.threeTesters.runtime2test.engine.instrument.aspects.MutInvocationPointcut"
                )
        )
        // Mostly for our ClosableLock
        .type(not(nameStartsWith("org.threeTesters.runtime2test.engine")))
        .and(packagesToInstrumentMatcher)
...
//                        .and(isAccessible)
                    ...
                    "org.threeTesters.runtime2test.engine.instrument.aspects.MutationTracingConstructorPointcut"
                )
        )
        .transform(
            new ForAdvice()
                ...
                .advice(
                    ...
                    "org.threeTesters.runtime2test.engine.instrument.aspects.MutationTracingMethodPointcut"
                )
        )
        .transform(
